export default function Sidebar() {
  return (
    <div className='h-full p-3 space-y-8 w-60 bg-white text-gray-800'>
      <div className="divide-y divide-gray-300">
        ...
        <ul className="pt-4 pb-2 space-y-8 text-sm">
          <li>
            <a href="#" className="flex items-center p-2 space-x-3 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <a href="#" className="flex items-center px-2 py-16 space-x-3 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="w-5 h-5 fill-current text-gray-600"
